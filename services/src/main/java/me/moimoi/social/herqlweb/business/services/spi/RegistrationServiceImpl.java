 ...
 */
package me.moimoi.social.herqlweb.business.services.spi;
...
public class RegistrationServiceImpl implements RegistrationService {
    ...
    @Inject
    public RegistrationServiceImpl(SocialIdentityService identityService,
    ...
    public void register(SocialIdentity identity) {        
        this.personService.register(identity.getProfiles().get(RegistrationServiceImpl.ONLY));
