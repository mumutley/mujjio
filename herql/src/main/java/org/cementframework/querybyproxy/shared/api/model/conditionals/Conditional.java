...
/**
 * Represents a conditional expression using in where and having clauses.
 *
 * @author allenparslow
 * @param <T>
 *            the type of conditional
 */
public interface Conditional<T> extends QueryFragment {

    /**
     * Gets the logic gate (conjunction) for the conditional.
     *
