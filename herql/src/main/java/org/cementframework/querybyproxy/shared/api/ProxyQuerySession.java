...
/**
 * Maintains state between query-builders and proxy-queries.
 *
 * @author allenparslow
 */
public interface ProxyQuerySession {
    ...
    /**
     * Gets the next logic gate (conjunction) to be used in the next operation.
     *
     * @return the next logic gate.
     */
